...
class CircleChanger(object):
    ...
    def __init__(self, x, y, radius, fill_color, colors):
        ...
        self.colors = colors
        self.oc = self.circle.fill_color
        self.index = 0
    ...
    def swallow(self, other_circle_changer):
        ...
        center1 = other_circle_changer.circle.center
        center2 = self.circle.center

        center = center1.plus(center2)
        x = center.x / 2
        y = center.y / 2
        radius = (center1.get_distance_from(center2)) / 2
        fill_color = 'red'

        return CircleChanger(x, y, radius, fill_color, self.colors +
                             other_circle_changer.colors)
